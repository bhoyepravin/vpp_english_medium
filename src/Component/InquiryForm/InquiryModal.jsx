    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-xl w-full max-w-lg shadow-lg relative">
          ...
          {/* Header */}
          <div className="bg-[#01143C] text-white px-6 py-4 rounded-t-xl flex justify-between items-center">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[#01143C] text-white py-2 rounded hover:bg-[#021A5E] transition"
            >
              Submit Inquiry
            </button>
          </form>
